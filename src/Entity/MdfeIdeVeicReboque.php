...
/**
 * @ORM\Entity(repositoryClass="App\Repository\MdfeIdeVeicReboqueRepository")
 */
class MdfeIdeVeicReboque
{
    /**
     * @ORM\Id()
     * @ORM\GeneratedValue()
    ...
    /**
     * @ORM\ManyToOne(targetEntity="App\Entity\MdfeIde", inversedBy="mdfeIdeVeicReboques")
     */
    private $mdfe;
