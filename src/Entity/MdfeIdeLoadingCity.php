...
/**
 * @ORM\Entity(repositoryClass="App\Repository\MdfeIdeLoadingCityRepository")
 */
class MdfeIdeLoadingCity
{
    /**
     * @ORM\ManyToMany(targetEntity="App\Entity\MdfeIde", mappedBy="loadingCities", cascade={"all"})
