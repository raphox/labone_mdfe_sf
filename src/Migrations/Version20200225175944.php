 ...
 */
final class Version20200225175944 extends AbstractMigration
{
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('DROP TABLE mdfe_ide_veic_reboque');
    }
}
